...
public:
     ...
     */
    virtual int64_t getLastRowIndex(int32_t pageIndex, int64_t rowGroupRowCount) const
    {
...
public:
    explicit OffsetIndexImpl(const std::vector<parquet::PageLocation> & page_locations) : page_locations_(page_locations) { }
